...
def validate_arguments(args: argparse.Namespace) -> None:
    ...
    if args.freeze_auxiliary_step > args.steps:
        raise ValueError(
            "--freeze-auxiliary-step cannot exceed --steps."
        )
...
def main() -> None:
    ...
    print(
        f"Unembedding LR before auxiliary freeze: "
        f"{args.unembedding_lr}"
    )
    print(
        f"Freeze all auxiliary parameters at step: "
        f"{args.freeze_auxiliary_step}"
    )
    ...
    with csv_path.open(
        ...
        for step in range(
            ...
            if (
                ...
                auxiliary_is_frozen = True

                print(
                    "Froze all AdamW-managed auxiliary "
