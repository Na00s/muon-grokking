...
- **Discussion, lines 421–423:** distinguish exact zero/nonzero Fourier support from a dominant-frequency ranking or thresholded set. General invertible maps preserve exact support; orthogonal maps also preserve Fourier powers and their rankings. The counterexample and implications are in `reservations_status.md`.
