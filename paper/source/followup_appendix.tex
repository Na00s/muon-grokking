...
All five reduced-LR branches experience a joint failure, compared with $5/5$ original stock trajectories and $0/5$ corrected-loss branches through the same horizon. We compare binary seed-level incidence because the original trajectories have different historical monitoring. The reduced-LR branches first fail between steps $17{,}041$ and $19{,}439$; seeds $0$, $2$, and $4$ reach approximately chance-level test accuracy ($100/113\approx0.885\%$). All recover to at least $99.6644\%$ final test accuracy. Their recovery illustrates why final accuracy alone misses these failures.
