...
The first captured joint failures occur at steps $17{,}494$, $17{,}721$, $18{,}069$, $16{,}308$, and $16{,}056$ for seeds $0$--$4$. Seeds $0$ and $4$ use exploratory dense replays from steps $16{,}000$ and $15{,}000$, respectively. Seed $0$'s earlier $100$-step log first detected failure at $17{,}500$; the grid missed seed $4$'s brief early failures. Seeds $1$--$3$ were specified together prospectively with the monitoring above and $200$ additional updates after capture. The selected failed decoder snapshots for seeds $3$ and $4$ are later states, $16{,}309$ and $16{,}060$, and retain those identities throughout.
...
\input{decoder_controls_appendix}

\input{rms_replication_appendix}
