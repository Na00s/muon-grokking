...
freeze; their trajectories differ only through backend nondeterminism, which
...
\midrule
Stable Muon & \multicolumn{3}{l}{Muon, with auxiliary and readout groups frozen after circuit formation} \\
\bottomrule
\end{tabular}
\end{table}
