\begin{table}[t]
\centering\small
\caption{Selected configurations. Muon and Stable Muon share the configuration before freezing; the paired CPU runs have identical logged pre-freeze metrics. Historical branch provenance is given in Appendix~\ref{app:control-provenance}.}
\label{tab:configs}
\begin{tabular}{llll}
\toprule
