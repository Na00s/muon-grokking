...
is the orthogonalized step before weight decay, varying by under three percent across
the pre-collapse rows. These rows come from spectral continuation S, sampled every ten updates. Net-step diagnostics use continuation I, sampled every update, whose first training failure is $44{,}702$ (Appendix~\ref{app:control-provenance}).}
\label{tab:quiet}
\begin{tabular}{lrrrr}
\toprule
